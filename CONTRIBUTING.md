...
**evidence** (`docs/ROADMAP.md:16-17`). That changes what a good contribution
...
- `--ignore-scripts` (install scripts stay **enabled** — `docs/ROADMAP.md:40`)
- pinned exact versions (semver ranges stay **wide open** — `docs/ROADMAP.md:41`)
...
purpose. A red scan is the project working (`docs/ROADMAP.md:43`). Do not "fix"
...
named commit and date (`docs/ROADMAP.md:31-35`).
